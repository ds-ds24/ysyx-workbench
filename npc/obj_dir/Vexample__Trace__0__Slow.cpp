...
VL_ATTR_COLD void Vexample___024root__trace_init_sub__TOP__0(Vexample___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+4,"out_assign", false,-1);
    tracep->declBit(c+5,"out_always_comb", false,-1);
    tracep->declBit(c+6,"out_always_ff", false,-1);
    tracep->pushNamePrefix("example ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"a", false,-1);
    tracep->declBit(c+3,"b", false,-1);
    tracep->declBit(c+4,"out_assign", false,-1);
    tracep->declBit(c+4,"out_always_comb", false,-1);
    tracep->declBit(c+6,"out_always_ff", false,-1);
...
VL_ATTR_COLD void Vexample___024root__trace_full_sub_0(Vexample___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,(vlSelf->out_assign));
    bufp->fullBit(oldp+5,(vlSelf->out_always_comb));
    bufp->fullBit(oldp+6,(vlSelf->out_always_ff));
}
